...
export default function SocialButtons({ onError }: SocialButtonsProps) {
  ...
  const handleOAuthLogin = async (provider: "google" | "apple" | "facebook") => {
    try {
      ...
      onError(err.message || `Could not sign in with ${provider}. Please try again.`);
    } finally {
    ...
    <div className="space-y-4" id="social-buttons-section">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center py-2.5 px-4 border border-stone-200 rounded-xl hover:bg-stone-50 hover:border-stone-300 transition-all cursor-pointer disabled:opacity-50"
